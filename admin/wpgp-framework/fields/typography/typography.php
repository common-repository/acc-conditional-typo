	...
	class WPGP_Field_typography extends WPGP_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_size'] ) ) {
				...
				echo '<input type="text" name="' . esc_attr( $this->field_name( '[font-size]' ) ) . '" class="wpgp--font-size wpgp--input wpgp-input-text" value="' . esc_attr( $this->value['font-size'] ) . '" placeholder="Example: 3.6rem" />';
			...
			if ( ! empty( $args['line_height'] ) ) {
				...
				echo '<div class="wpgp--input-wrap">';
				echo '<input type="text" name="' . esc_attr( $this->field_name( '[line-height]' ) ) . '" class="wpgp--line-height wpgp--input wpgp-input-text" value="' . esc_attr( $this->value['line-height'] ) . '" placeholder="Example: 1.13" />';
			...
			if ( ! empty( $args['letter_spacing'] ) ) {
				...
				echo '<div class="wpgp--input-wrap">';
				echo '<input type="text" name="' . esc_attr( $this->field_name( '[letter-spacing]' ) ) . '" class="wpgp--letter-spacing wpgp--input wpgp-input-text" value="' . esc_attr( $this->value['letter-spacing'] ) . '" placeholder="Example: 1px" />';
				// echo '<span class="wpgp--unit">' . esc_attr( $args['unit'] ) . '</span>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['word_spacing'] ) ) {
				...
				echo '<div class="wpgp--input-wrap">';
				echo '<input type="text" name="' . esc_attr( $this->field_name( '[word-spacing]' ) ) . '" class="wpgp--word-spacing wpgp--input wpgp-input-text" value="' . esc_attr( $this->value['word-spacing'] ) . '" placeholder="Example: 4px" />';
				// echo '<span class="wpgp--unit">' . esc_attr( $args['unit'] ) . '</span>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['background-color'] ) ) {
				$default_color_attr = ( ! empty( $default_value['background-color'] ) ) ? ' data-default-background-color="' . esc_attr( $default_value['background-color'] ) . '"' : '';
				echo '<div class="wpgp--block wpgp--block-font-color">';
				echo '<div class="wpgp--title">' . esc_html__( 'Background Color', 'wpgp' ) . '</div>';
				echo '<div class="wpgp-field-color">';
				echo '<input type="text" name="' . esc_attr( $this->field_name( '[background-color]' ) ) . '" class="wpgp-color wpgp--background-color" value="' . esc_attr( $this->value['background-color'] ) . '"' . $default_color_attr . ' />';
				echo '</div>';
				echo '</div>';
			}
