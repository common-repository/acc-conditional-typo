 ...
 */
class ACC_Conditional_Typo_CPT {
	...
	public function gpsc_custom_post_type() {
		...
		$labels = apply_filters(
			...
			array(
				'name'               => esc_html_x( 'Manage Code', 'acc-conditional-typo' ),
				'singular_name'      => esc_html_x( 'Code', 'acc-conditional-typo' ),
				'add_new'            => esc_html__( 'Add New', 'acc-conditional-typo' ),
				'add_new_item'       => esc_html__( 'Add New Gallery', 'acc-conditional-typo' ),
				'edit_item'          => esc_html__( 'Edit Code', 'acc-conditional-typo' ),
				'new_item'           => esc_html__( 'New Code', 'acc-conditional-typo' ),
				'view_item'          => esc_html__( 'View  Code', 'acc-conditional-typo' ),
				'search_items'       => esc_html__( 'Search Code', 'acc-conditional-typo' ),
				'not_found'          => esc_html__( 'No Gallery found.', 'acc-conditional-typo' ),
				'not_found_in_trash' => esc_html__( 'No Gallery found in trash.', 'acc-conditional-typo' ),
				'parent_item_colon'  => esc_html__( 'Parent Item:', 'acc-conditional-typo' ),
				'menu_name'          => esc_html__( 'A. Custom Code', 'acc-conditional-typo' ),
				'all_items'          => esc_html__( 'Manage Code', 'acc-conditional-typo' ),
			)
		);
		...
		$args = apply_filters(
			...
			array(
				...
				'menu_position'       => apply_filters( self::PAGE_ID . '_menu_position', 75 ),
	...
	public function ptc_help_callback() {
		...
		include_once ACC_CONDITIONAL_TYPO_DIR_PATH_FILE . '/admin/partials/acc-conditional-typo-admin-display.php';
	}
